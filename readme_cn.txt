...
（2）修改'E2E_CNN_simu/Model/Config.yaml'中的相应配置项 （若有预训练模型，在model_filename项中填写其路径，如'Result/Model-Config/Decoder-T0519121103-D0.10L0.001-RMSE/models-0.2041-117480'）
（3）运行 E2E_CNN_simu/train.py代码，进行训练
